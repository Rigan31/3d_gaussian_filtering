#
# LightGaussian-style Pruning Defense for Poison-Splat
#
# Implements the Global Significance Score from:
#   "LightGaussian: Unbounded 3D Gaussian Compression with 15x Reduction and 200+ FPS"
#   Zhiwen Fan, Kevin Wang, Kairun Wen, Zehao Zhu, Dejia Xu, Zhangyang Wang
#   NeurIPS 2024 Spotlight
#
# Adapted for use as a defense mechanism against Poison-Splat computation cost attacks.
# Instead of a post-hoc one-shot prune, this integrates pruning into the training loop
# at specified iterations, following the "train_densify_prune" paradigm from LightGaussian.
#

...
# All rights reserved.
#
# Modified to integrate SpeedySplat-style pruning defense against
# Poison-Splat computation cost attacks.
#
# SpeedySplat defense uses:
#   - Soft Pruning: gradient-based sensitivity pruning at each densification step
#   - Hard Pruning: comprehensive multi-view sensitivity pruning after densification
#
